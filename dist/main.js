...
var DataviewComponent = /** @class */ (function () {
    ...
    DataviewComponent.prototype.getResultData = function (site) {
        ...
        this._http.get(resultUrl)
            ...
            _this.result = csv;
            _this.result = _this.csvJSON(_this.result._body);
            _this.resultJson = JSON.parse(_this.result);
            _this.createSiteChart(site);
        });
    };
    ...
    DataviewComponent.prototype.createSiteChart = function (site) {
        ...
        for (var i = 0; i < this.resultJson.length; i++) { // creating separate series based on properties
            var value = this.resultJson[i]['ActivityBottomDepthHeightMeasure/MeasureValue']; // can replace this with other properties
    ...
    DataviewComponent.prototype.getStatData = function () {
        ...
        this.orgChart = new highcharts__WEBPACK_IMPORTED_MODULE_1__["Chart"]('orgChart', this._orgChartOptions);
