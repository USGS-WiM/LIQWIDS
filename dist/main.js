...
var DataviewComponent = /** @class */ (function () {
    ...
    DataviewComponent.prototype.ngOnInit = function () {
        ...
        this._mapService.SelectedSite.subscribe(function (Response) {
            ...
            if (_this.urlSites[0] !== Response.name) {
                ...
                _this.urlParams.set('sites', _this.urlSites.join(','));
    ...
    DataviewComponent.prototype.getUrlSites = function () {
        ...
        if (this.urlParams.get('sites') !== null) {
            this.urlSites = this.urlParams.get('sites').split(',');
        }
        else {
            this.urlSites = [];
        }
...
var SidebarComponent = /** @class */ (function () {
    ...
    SidebarComponent.prototype.ngOnInit = function () {
        ...
        if (this.urlParams.get('sites') !== null) {
            this.urlSelSites = this.urlParams.get('sites').split(',');
        }
        else {
            this.urlSelSites = [];
        }
    ...
    SidebarComponent.prototype.setChar = function (characteristics) {
        for (var i = 0; i < characteristics.length; i++) {
            ...
            else if (char === 'Inorganic nitrogen') {
                characteristics[i] = 'Inorganic nitrogen (nitrate and nitrite)';
            }
        }
